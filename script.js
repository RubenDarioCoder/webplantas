...
function abrirWhatsApp(nombrePlanta) {
    var numero = "541127268317";
    var mensaje = `Hola! quiero ${nombrePlanta}. Soy `;
...
function agregarPlanta(plantas) {
    plantas.forEach(planta => {
        ...
        buttonPedirW.classList.add('botonPedirW');
        buttonPedirW.addEventListener('click', () => abrirWhatsApp(planta.nombre));
        ...
        articulo.appendChild(buttonPedirW);
